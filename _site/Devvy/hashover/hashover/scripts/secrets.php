<?php
	...
	$encryption_key		= '0okmNJI(8uh';			// Unique 8 to 32 character encryption key
	$notification_email	= 'realtoughcandy@gmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'pastasauce';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'macaroni12!@';			// Password to gain admin rights
